...
export interface BitTooltipProps
  extends
    ...
    VariantProps<typeof tooltipVariants> {
  delayDuration?: number; // <-- Add this line
}
...
function TooltipProvider({
  ...
  return (
    <ShadcnTooltipProvider delay={delayDuration} {...props}>
      {children}
    </ShadcnTooltipProvider>
  );
}

export interface BitTooltipTriggerProps extends React.ComponentPropsWithoutRef<
  typeof ShadcnTooltipTrigger
> {}

function TooltipTrigger({ children, ...props }: BitTooltipTriggerProps) {
  return (
